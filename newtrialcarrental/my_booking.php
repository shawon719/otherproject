              ...
              <?php } ?>
                    ...
                    <div class="notification">
                       ...
                       if ($_SERVER["REQUEST_METHOD"] == "POST") {
                         // নোটিফিকেশন অ্যাডমিনের জন্য
                        $notification = "New booking from $customer_name for $car_model on $booking_date.";

                      // নোটিফিকেশন টেবিলেও ডেটা ইনসার্ট করা
                      $notification_sql = "INSERT INTO notifications (message) VALUES (:message)";
                      $notification_stmt = $pdo->prepare($notification_sql);
                      $notification_stmt->bindParam(':message', $notification);
