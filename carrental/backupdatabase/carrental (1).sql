...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2025 at 11:06 PM
...
CREATE TABLE `payment_history` (
  ...
  `userEmaill` varchar(255) NOT NULL,
...
INSERT INTO `tblbooking` (`id`, `user_id`, `BookingNumber`, `userEmail`, `VehicleId`, `FromDate`, `ToDate`, `message`, `Status`, `payment_status`, `PostingDate`, `LastUpdationDate`) VALUES
(1, 1, 443108139, 'amikt12@gmail.com', 2, '2024-06-08', '2024-06-10', 'I want booking', 1, '', '2024-06-05 05:32:39', '2025-01-25 21:15:10'),
(2, 2, 455509357, 's.sawon@2001', 5, '2025-01-20', '2025-01-21', 'qwfeg', 0, '', '2025-01-19 16:16:40', NULL),
(3, 3, 591470572, 's.sawon@2001', 6, '2025-01-21', '2025-01-23', 'uhugug', 0, '', '2025-01-19 17:56:08', NULL),
(4, 4, 795218765, 's.sawon@2001', 4, '2025-01-24', '2025-01-26', 'bubj', 0, '', '2025-01-19 18:34:03', NULL);
...
CREATE TABLE `tblusers` (
  ...
  `Driving_license` int(15) NOT NULL,
  `ContactNo` char(11) DEFAULT NULL,
...
INSERT INTO `tblusers` (`id`, `FullName`, `EmailId`, `Password`, `Driving_license`, `ContactNo`, `dob`, `Address`, `City`, `Country`, `RegDate`, `UpdationDate`) VALUES
(1, 'Test', 'test@gmail.com', 'f925916e2754e5e03f75dd58a5733251', 1, '6465465465', '', 'L-890, Gaur City Ghaziabad', 'Ghaziabad', 'India', '2024-05-01 14:00:49', '2025-01-25 17:43:26'),
(3, 'shawon', 's.sawon@2001', 'f5ff2e5b2131285bbdf494115cfda502', 2, '0175210071', NULL, NULL, NULL, NULL, '2025-01-19 15:57:11', NULL);
